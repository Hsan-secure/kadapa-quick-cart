...
export const products: Product[] = [
  ...
  { id: 'broccoli-500g', name: 'Fresh Broccoli', slug: 'broccoli-500g', categoryId: 'fruits-veg', unit: '500 g', price: 65, mrp: 75, image: productImages['broccoli.jpg'], rating: 4.4, inStock: true, stockQty: 30, isVegetarian: true, tags: ['fresh', 'healthy'], discount: 13 },
  { id: 'okra-500g', name: 'Fresh Okra (Ladyfinger)', slug: 'okra-500g', categoryId: 'fruits-veg', unit: '500 g', price: 28, mrp: 35, image: productImages['okra.jpg'], rating: 4.1, inStock: true, stockQty: 40, isVegetarian: true, tags: ['fresh', 'vegetable'], discount: 20 },
  { id: 'green-beans-500g', name: 'Fresh Green Beans', slug: 'green-beans-500g', categoryId: 'fruits-veg', unit: '500 g', price: 35, mrp: 42, image: productImages['green-beans.jpg'], rating: 4.2, inStock: true, stockQty: 35, isVegetarian: true, tags: ['fresh', 'crisp'], discount: 17 },
  { id: 'eggplant-500g', name: 'Fresh Eggplant (Brinjal)', slug: 'eggplant-500g', categoryId: 'fruits-veg', unit: '500 g', price: 32, mrp: 40, image: productImages['eggplant.jpg'], rating: 4.0, inStock: true, stockQty: 38, isVegetarian: true, tags: ['fresh', 'purple'], discount: 20 },
  { id: 'strawberries-250g', name: 'Fresh Strawberries', slug: 'strawberries-250g', categoryId: 'fruits-veg', unit: '250 g', price: 145, mrp: 165, image: productImages['strawberries.jpg'], rating: 4.6, inStock: true, stockQty: 25, isVegetarian: true, tags: ['fresh', 'premium'], discount: 12 },
  { id: 'pineapple-1pc', name: 'Fresh Pineapple', slug: 'pineapple-1pc', categoryId: 'fruits-veg', unit: '1 pc', price: 85, mrp: 95, image: productImages['pineapple.jpg'], rating: 4.4, inStock: true, stockQty: 20, isVegetarian: true, tags: ['fresh', 'tropical'], discount: 11 },
  { id: 'papaya-1kg', name: 'Fresh Papaya', slug: 'papaya-1kg', categoryId: 'fruits-veg', unit: '1 kg', price: 55, mrp: 65, image: productImages['papaya.jpg'], rating: 4.3, inStock: true, stockQty: 30, isVegetarian: true, tags: ['fresh', 'sweet'], discount: 15 },
  ...
  { id: 'greek-yogurt-500g', name: 'Greek Yogurt', slug: 'greek-yogurt-500g', categoryId: 'dairy-eggs', unit: '500 g', price: 185, mrp: 210, image: productImages['greek-yogurt.jpg'], rating: 4.5, inStock: true, stockQty: 25, isVegetarian: true, tags: ['healthy', 'protein'], discount: 12 },
  { id: 'mozzarella-200g', name: 'Fresh Mozzarella', slug: 'mozzarella-200g', categoryId: 'dairy-eggs', unit: '200 g', price: 165, mrp: 185, image: productImages['mozzarella.jpg'], rating: 4.4, inStock: true, stockQty: 20, isVegetarian: true, tags: ['premium', 'fresh'], discount: 11 },
  ...
  { id: 'wheat-pasta-500g', name: 'Whole Wheat Pasta', slug: 'wheat-pasta-500g', categoryId: 'staples', unit: '500 g', price: 85, mrp: 95, image: productImages['wheat-pasta.jpg'], rating: 4.3, inStock: true, stockQty: 35, isVegetarian: true, tags: ['healthy', 'whole-grain'], discount: 11 },
  { id: 'quinoa-500g', name: 'Organic Quinoa', slug: 'quinoa-500g', categoryId: 'staples', unit: '500 g', price: 485, mrp: 550, image: productImages['quinoa.jpg'], rating: 4.6, inStock: true, stockQty: 20, isVegetarian: true, tags: ['superfood', 'organic'], discount: 12 },
  { id: 'oats-1kg', name: 'Rolled Oats', slug: 'oats-1kg', categoryId: 'staples', unit: '1 kg', price: 165, mrp: 185, image: productImages['oats.jpg'], rating: 4.4, inStock: true, stockQty: 40, isVegetarian: true, tags: ['healthy', 'fiber'], discount: 11 },
  { id: 'pasta-sauce-400g', name: 'Organic Pasta Sauce', slug: 'pasta-sauce-400g', categoryId: 'staples', unit: '400 g', price: 145, mrp: 165, image: productImages['pasta-sauce.jpg'], rating: 4.2, inStock: true, stockQty: 30, isVegetarian: true, tags: ['organic', 'tomato'], discount: 12 },
  ...
  { id: 'dark-chocolate-100g', name: 'Dark Chocolate Bar', slug: 'dark-chocolate-100g', categoryId: 'snacks', unit: '100 g', price: 185, mrp: 210, image: productImages['dark-chocolate.jpg'], rating: 4.5, inStock: true, stockQty: 45, isVegetarian: true, tags: ['premium', 'cocoa'], discount: 12 },
  { id: 'protein-bar-60g', name: 'Protein Energy Bar', slug: 'protein-bar-60g', categoryId: 'snacks', unit: '60 g', price: 85, mrp: 95, image: productImages['protein-bar.jpg'], rating: 4.3, inStock: true, stockQty: 50, isVegetarian: true, tags: ['healthy', 'fitness'], discount: 11 },
  ...
  { id: 'coconut-water-1l', name: 'Natural Coconut Water', slug: 'coconut-water-1l', categoryId: 'beverages', unit: '1 L', price: 95, mrp: 110, image: productImages['coconut-water.jpg'], rating: 4.4, inStock: true, stockQty: 35, isVegetarian: true, tags: ['natural', 'hydrating'], discount: 14 },
  { id: 'green-tea-25bags', name: 'Green Tea', slug: 'green-tea-25bags', categoryId: 'beverages', unit: '25 bags', price: 185, mrp: 210, image: productImages['green-tea.jpg'], rating: 4.5, inStock: true, stockQty: 40, isVegetarian: true, tags: ['healthy', 'antioxidant'], discount: 12 },
  { id: 'apple-juice-1l', name: 'Apple Juice', slug: 'apple-juice-1l', categoryId: 'beverages', unit: '1 L', price: 165, mrp: 185, image: productImages['apple-juice.jpg'], rating: 4.3, inStock: true, stockQty: 30, isVegetarian: true, tags: ['fruit', 'natural'], discount: 11 },
  { id: 'energy-drink-250ml', name: 'Energy Drink', slug: 'energy-drink-250ml', categoryId: 'beverages', unit: '250 ml', price: 85, mrp: 95, image: productImages['energy-drink.jpg'], rating: 4.2, inStock: true, stockQty: 55, isVegetarian: true, tags: ['energy', 'sports'], discount: 11 },
  ...
  { id: 'whole-grain-cereal-500g', name: 'Whole Grain Cereal', slug: 'whole-grain-cereal-500g', categoryId: 'breakfast', unit: '500 g', price: 245, mrp: 275, image: productImages['whole-grain-cereal.jpg'], rating: 4.4, inStock: true, stockQty: 35, isVegetarian: true, tags: ['healthy', 'fiber'], discount: 11 },
  ...
  { id: 'shampoo-400ml', name: 'Hair Shampoo', slug: 'shampoo-400ml', categoryId: 'personal-care', unit: '400 ml', price: 185, mrp: 210, image: productImages['shampoo.jpg'], rating: 4.4, inStock: true, stockQty: 45, tags: ['hair-care', 'cleansing'], discount: 12 },
  { id: 'hand-sanitizer-250ml', name: 'Hand Sanitizer', slug: 'hand-sanitizer-250ml', categoryId: 'personal-care', unit: '250 ml', price: 85, mrp: 95, image: productImages['hand-sanitizer.jpg'], rating: 4.3, inStock: true, stockQty: 60, tags: ['hygiene', 'antibacterial'], discount: 11 },
  { id: 'face-wash-150ml', name: 'Gentle Face Wash', slug: 'face-wash-150ml', categoryId: 'personal-care', unit: '150 ml', price: 165, mrp: 185, image: productImages['face-wash.jpg'], rating: 4.4, inStock: true, stockQty: 40, tags: ['skincare', 'cleansing'], discount: 11 },
  { id: 'moisturizer-100ml', name: 'Daily Moisturizer', slug: 'moisturizer-100ml', categoryId: 'personal-care', unit: '100 ml', price: 285, mrp: 325, image: productImages['moisturizer.jpg'], rating: 4.5, inStock: true, stockQty: 35, tags: ['skincare', 'hydrating'], discount: 12 },
  { id: 'sunscreen-50ml', name: 'SPF 30 Sunscreen', slug: 'sunscreen-50ml', categoryId: 'personal-care', unit: '50 ml', price: 385, mrp: 435, image: productImages['sunscreen.jpg'], rating: 4.6, inStock: true, stockQty: 30, tags: ['sun-protection', 'skincare'], discount: 11 },
  { id: 'body-lotion-400ml', name: 'Body Lotion', slug: 'body-lotion-400ml', categoryId: 'personal-care', unit: '400 ml', price: 245, mrp: 275, image: productImages['body-lotion.jpg'], rating: 4.4, inStock: true, stockQty: 40, tags: ['skincare', 'moisturizing'], discount: 11 },
  { id: 'conditioner-200ml', name: 'Hair Conditioner', slug: 'conditioner-200ml', categoryId: 'personal-care', unit: '200 ml', price: 185, mrp: 210, image: productImages['conditioner.jpg'], rating: 4.3, inStock: true, stockQty: 45, tags: ['hair-care', 'smoothing'], discount: 12 },
  { id: 'mouthwash-500ml', name: 'Antiseptic Mouthwash', slug: 'mouthwash-500ml', categoryId: 'personal-care', unit: '500 ml', price: 165, mrp: 185, image: productImages['mouthwash.jpg'], rating: 4.4, inStock: true, stockQty: 50, tags: ['oral-care', 'fresh'], discount: 11 },
  ...
  { id: 'fabric-softener-1l', name: 'Fabric Softener', slug: 'fabric-softener-1l', categoryId: 'household', unit: '1 L', price: 165, mrp: 185, image: productImages['fabric-softener.jpg'], rating: 4.2, inStock: true, stockQty: 35, tags: ['laundry', 'softening'], discount: 11 },
  { id: 'toilet-paper-4rolls', name: 'Toilet Paper', slug: 'toilet-paper-4rolls', categoryId: 'household', unit: '4 rolls', price: 145, mrp: 165, image: productImages['toilet-paper.jpg'], rating: 4.3, inStock: true, stockQty: 50, tags: ['hygiene', 'essential'], discount: 12 },
  ...
  { id: 'baby-formula-400g', name: 'Baby Formula Milk', slug: 'baby-formula-400g', categoryId: 'baby-care', unit: '400 g', price: 685, mrp: 775, image: productImages['baby-formula.jpg'], rating: 4.6, inStock: true, stockQty: 25, tags: ['infant', 'nutrition'], discount: 12 },
  ...
  { id: 'chicken-breast-500g', name: 'Chicken Breast', slug: 'chicken-breast-500g', categoryId: 'meat-seafood', unit: '500 g', price: 185, mrp: 210, image: productImages['chicken-breast.jpg'], rating: 4.4, inStock: true, stockQty: 25, tags: ['fresh', 'lean'], discount: 12 },
  { id: 'mutton-1kg', name: 'Fresh Mutton', slug: 'mutton-1kg', categoryId: 'meat-seafood', unit: '1 kg', price: 685, mrp: 775, image: productImages['mutton.jpg'], rating: 4.3, inStock: true, stockQty: 15, tags: ['fresh', 'premium'], discount: 12 },
  { id: 'fish-fillet-500g', name: 'Fish Fillet', slug: 'fish-fillet-500g', categoryId: 'meat-seafood', unit: '500 g', price: 385, mrp: 435, image: productImages['fish-fillet.jpg'], rating: 4.4, inStock: true, stockQty: 20, tags: ['fresh', 'boneless'], discount: 11 },
  { id: 'salmon-500g', name: 'Fresh Salmon', slug: 'salmon-500g', categoryId: 'meat-seafood', unit: '500 g', price: 885, mrp: 995, image: productImages['salmon.jpg'], rating: 4.6, inStock: true, stockQty: 12, tags: ['premium', 'omega-3'], discount: 11 },
  { id: 'crab-500g', name: 'Fresh Crab', slug: 'crab-500g', categoryId: 'meat-seafood', unit: '500 g', price: 585, mrp: 665, image: productImages['crab.jpg'], rating: 4.5, inStock: true, stockQty: 10, tags: ['fresh', 'delicacy'], discount: 12 },
  ...
  // Bakery
  { id: 'croissant-4pcs', name: 'Fresh Croissants', slug: 'croissant-4pcs', categoryId: 'bakery', unit: '4 pcs', price: 125, mrp: 145, image: productImages['croissant.jpg'], rating: 4.5, inStock: true, stockQty: 30, isVegetarian: true, tags: ['fresh', 'flaky'], discount: 14 },
  { id: 'white-bread-400g', name: 'White Bread', slug: 'white-bread-400g', categoryId: 'bakery', unit: '400 g', price: 32, mrp: 38, image: productImages['white-bread.jpg'], rating: 4.2, inStock: true, stockQty: 50, isVegetarian: true, tags: ['fresh', 'soft'], discount: 16 },
  { id: 'blueberry-muffin-6pcs', name: 'Blueberry Muffins', slug: 'blueberry-muffin-6pcs', categoryId: 'bakery', unit: '6 pcs', price: 185, mrp: 210, image: productImages['blueberry-muffin.jpg'], rating: 4.6, inStock: true, stockQty: 25, isVegetarian: true, tags: ['fresh', 'fruity'], discount: 12 },
  { id: 'chocolate-cake-500g', name: 'Chocolate Cake', slug: 'chocolate-cake-500g', categoryId: 'bakery', unit: '500 g', price: 385, mrp: 435, image: productImages['chocolate-cake.jpg'], rating: 4.7, inStock: true, stockQty: 20, isVegetarian: true, tags: ['premium', 'celebration'], discount: 11 },
  { id: 'donuts-6pcs', name: 'Glazed Donuts', slug: 'donuts-6pcs', categoryId: 'bakery', unit: '6 pcs', price: 165, mrp: 185, image: productImages['donuts.jpg'], rating: 4.4, inStock: true, stockQty: 35, isVegetarian: true, tags: ['sweet', 'glazed'], discount: 11 },
  { id: 'danish-pastry-4pcs', name: 'Danish Pastries', slug: 'danish-pastry-4pcs', categoryId: 'bakery', unit: '4 pcs', price: 145, mrp: 165, image: productImages['danish-pastry.jpg'], rating: 4.5, inStock: true, stockQty: 30, isVegetarian: true, tags: ['fresh', 'flaky'], discount: 12 },
  { id: 'bagel-4pcs', name: 'Sesame Bagels', slug: 'bagel-4pcs', categoryId: 'bakery', unit: '4 pcs', price: 85, mrp: 95, image: productImages['bagel.jpg'], rating: 4.3, inStock: true, stockQty: 40, isVegetarian: true, tags: ['fresh', 'classic'], discount: 11 },
  { id: 'pita-bread-6pcs', name: 'Pita Bread', slug: 'pita-bread-6pcs', categoryId: 'bakery', unit: '6 pcs', price: 65, mrp: 75, image: productImages['pita-bread.jpg'], rating: 4.2, inStock: true, stockQty: 35, isVegetarian: true, tags: ['fresh', 'versatile'], discount: 13 },
